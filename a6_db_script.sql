...
CREATE TABLE IF NOT EXISTS cloud.partOrders (
jobName VARCHAR(10) NOT NULL,
partID int NOT NULL,
userID int NOT NULL,
qty int NOT NULL,
...
INSERT INTO cloud.partOrders VALUES ('job1', 1, '101', 1);
INSERT INTO cloud.partOrders VALUES ('job2', 2, '102', 2);
INSERT INTO cloud.partOrders VALUES ('job3', 3, '103', 3);

select * from cloud.partOrders;